...
Applications evaluated:
 ...
 - [Homegrown with Bonnie Plants](https://itunes.apple.com/ca/app/homegrown-with-bonnie-plants/id958646256?mt=8)
...
####_Homegrown with Bonnie Plants_:

Feature evaluation:
The ability to take down notes is one of the principal features implemented in this application, it can track your garden’s progress through the seasons, including planting, watering, feeding, and harvesting. Although these are fairly basic features and are already available on many other existing applications, this application provides clear steps and simple operations to manage the garden. For example, users can use this application to keep track of the date they plan to water, fertilize and so forth. Furthermore, this application provides the beginners a variety of  selections of growing plants from easy to tough. For instance, there is a feature called “help me choose” in the title page. Users can find different sections about managing a garden or planting certain plants based on different criterias. They can select the one that is suitable for them and then are able to find the plants falling in this range. Thirdly, this application can get user’s current location and provides user accurate weather information per hours. Since weather is an important feature that affects plants growing, being able to forecast the weather makes managing a garden much easier. For example, the application shows weather information at the top of the title page. User can get to know that there will be a rainfall from 11am to 2pm at this region so they likely do not have to water their plants at that time. Lastly, this application allows user upload and share photos of their plants to social networks via the sharing feature. This is an interesting functionality that can record the history of plants growing, as well as sharing these stories to social networks. By uploading and sharing photos to social networks, user can get a sense of leisure and happiness. 


Reviews: 
Does not have any reviews as of writting this.
